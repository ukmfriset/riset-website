...
import { newsData } from "@/data/berita/newsData";

export default function NewsDetail() {
  const params = useParams();
  const article = newsData.find((item) => item.id === params?.slug);
  ...
  const readTime = Math.max(1, Math.ceil(article.content.length / 800));
    ...
    <main style={{ backgroundColor: "#ffffff", color: "#1e293b", minHeight: "100vh", position: "relative", overflowX: "hidden" }}>
      ...
      <div
        style={{
          ...
          width: `${progress}%`,
          height: "3px",
          background: "linear-gradient(90deg, var(--accent-orange-text), #FB923C)",
          zIndex: 100,
      ...
      <section
        style={{
          background: "linear-gradient(180deg, var(--accent-orange-bg) 0%, #ffffff 100%)",
          padding: isMobile ? "80px 16px 40px" : "120px 24px 60px",
          position: "relative",
          overflow: "hidden",
        }}
      >
        {/* Decorative blur - FIX: responsive size */}
        <div
          style={{
            position: "absolute",
            top: "-10%",
        ...
        >
          ...
          >
            <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
              <span style={{ width: "36px", height: "36px", borderRadius: "50%", background: "var(--accent-orange-bg)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "16px" }}>
                👤
              </span>
              <div>
      ...
      {/* ─── Content Grid - FIX: single column di mobile ─── */}
      <section
        style={{
          maxWidth: 1000,
          margin: "0 auto 100px",
      ...
      >
          ...
          {article.excerpt && (
            <p
              style={{
                ...
                marginBottom: "2.5rem",
                paddingLeft: "24px",
                borderLeft: "4px solid var(--accent-orange-border)",
                fontStyle: "italic",
              }}
            >
              {article.excerpt}
          ...
          {paragraphs.map((paragraph, i) => (
            <p
              ...
              style={{
                ...
                transition: `opacity 0.6s ease ${0.3 + i * 0.05}s, transform 0.6s ease ${0.3 + i * 0.05}s`,
              }}
            >
              {paragraph}
            </p>
            ...
            <div style={{ display: "flex", gap: "8px", flexWrap: "wrap" }}>
              {["Berita", article.category, "UKM-F Riset", "UTM"].map((tag) => (
                <span
                  ...
                  onMouseEnter={(e) => {
                    e.currentTarget.style.background = "var(--accent-orange-bg)";
                    e.currentTarget.style.color = "var(--accent-orange-text)";
                  }}
                  onMouseLeave={(e) => {
        ...
        {/* Sidebar - FIX: tidak sticky di mobile */}
        <aside>
          <div
            style={{
          ...
          >
            ...
            <div
              style={{
                marginBottom: "24px",
                padding: "12px 16px",
                background: "linear-gradient(135deg, var(--accent-orange-bg) 0%, #ffffff 100%)",
                borderRadius: "16px",
                textAlign: "center",
                border: "1px solid var(--accent-orange-border)",
              }}
            >
              <span style={{ fontSize: "13px", color: "var(--accent-orange-text)", fontWeight: 700 }}>
            ...
            <div style={{ textAlign: "center", marginBottom: "24px" }}>
              <div
                style={{
                  ...
                  height: "64px",
                  borderRadius: "50%",
                  background: "linear-gradient(135deg, var(--accent-orange-bg), var(--accent-orange-border))",
                  display: "flex",
                  alignItems: "center",
                  justifyContent: "center",
                  fontSize: "28px",
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
              <ActionButton onClick={copyLink} icon="🔗" label="Salin Link" />
              <ActionButton onClick={shareWhatsApp} icon="💬" label="WhatsApp" />
              <ActionButton onClick={shareTwitter} icon="🐦" label="Twitter / X" />
            </div>
      ...
      >
        ...
        >
          <div>
            <span style={{ fontSize: "12px", fontWeight: 700, color: "var(--accent-orange-text)", textTransform: "uppercase", letterSpacing: "1px" }}>
              Navigasi
            </span>
  ...
  return (
    <button
      ...
      style={{
        ...
        borderRadius: "12px",
        border: "1px solid #E2E8F0",
        background: isHovered ? "var(--accent-orange-bg)" : "#ffffff",
        cursor: "pointer",
        fontWeight: 600,
        fontSize: "14px",
        color: isHovered ? "var(--accent-orange-text)" : "#334155",
        display: "flex",
        alignItems: "center",
        gap: "10px",
        transition: "all 0.2s ease",
